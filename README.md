...
If you already have an earlier Jarvis preview, **do not uninstall it first**.

### 1. Download

Download the installer:

**[Jarvis 0.3.0 Executive Preview DMG](https://github.com/JT5D/jarvis-releases/releases/download/native-v0.3.0/Jarvis-0.3.0-ExecutivePreview.dmg)**
...
Full release page: https://github.com/JT5D/jarvis-releases/releases/tag/native-v0.3.0

### 2. Install

1. Double-click `Jarvis-0.3.0-ExecutivePreview.dmg`.
2. Drag **Jarvis** into **Applications**.
3. Open **Applications -> Jarvis**.
4. If macOS asks whether to open Jarvis, click **Open**.
...
Open **Jarvis -> Controls -> Version & updates** and confirm:

- **Installed:** `0.3.0 (3001)`
- **Latest seen:** `0.3.0 (3001)`
- update status is healthy
...
Normally you should not need to reinstall. If you receive a newer DMG manually:
...
Native releases are Developer ID signed, Apple-notarized, Gatekeeper-verified, SHA-256 hashed, and published with a signed native update manifest and SBOM. The current update manifest and detached signature are in `native/manifest.json` and `native/manifest.json.sig` in this repository.
